...
export const productListReducer=(state={products:[] },action)=>{
     ...
     switch(action.type){
         ...
         case   PRODUCT_LIST_SUCCESS:
             return { loading:false, products:action.payload.Product, pages:action.payload.pages,page:action.payload.page,hello:"nice"}  //here i wrote hello we can add any think in object
